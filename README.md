...
Let's walk through how to use the exaample program. First we will train the model, telling the program to save intermediate results in the directory `work`:
